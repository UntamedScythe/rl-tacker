...
import { extractGameStats, aggregateGameStats, type GameStats, type PlayerStatsBlock } from '@/lib/metrics'
...
export function aggregateStats(replays: Replay[], playerId: string) {
  ...
  for (const replay of replays) {
    ...
    games.push(extractGameStats(me.stats))
  }
